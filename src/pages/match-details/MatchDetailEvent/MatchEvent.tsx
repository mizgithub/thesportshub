...
const MatchEvent = ({ beforeHalf, afterHalf, liveTime }: propType) => {
    ...
    return (
        <div className="flex flex-col p-[16px] gap-[16px] bg-[#1D1E2B] rounded-[16px] border-b-[1px] border-[#292B41] justify-center items-center overflow-x-hidden">
            <div className="h-[20px] flex justify-start w-full">
                <span className="text-[14px] font-[500] leading-[20px] text-white justify-start">Events</span>
            </div>
            {liveTime!=="NS" &&<>
